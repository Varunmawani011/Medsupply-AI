    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      `}>
        <div className="flex flex-col h-full">
          {/* Logo Header - Click to go Home/Logout */}
          <button 
            onClick={onLogout}
            className="p-6 border-b border-slate-700 flex items-center hover:bg-slate-800 transition-colors w-full text-left"
          >
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Click to return Home</p>
            </div>
          </button>
          ...
          <nav className="flex-1 p-4 overflow-y-auto">
            <div className="mb-6">
              ...
              {/* Home / Switch Persona Button */}
              <button
                onClick={() => {
                  onLogout();
                  setIsMobileMenuOpen(false);
                }}
                className="flex items-center w-full px-4 py-3 mb-1 rounded-lg transition-colors text-slate-400 hover:bg-slate-800 hover:text-white"
              >
